...
const DEFAULT_NUM_SQUARES = 25; // Default number of squares for initial render
        ...
        {Array.from({ length: numSquares * numSquares }).map((_, index) => (
          ...
          >
            <div
              ...
              style={{
                border: `${1.86}px solid #EBEBEB`, // Thicker border for large boxes
              }}
            >
              {Array.from({ length: 16 }).map((_, smallIndex) => (
                <div
                  ...
                  style={{
                    ...
                    border: `${1.33}px solid #EBEBEB`, // Thinner border for small boxes
                  }}
                />
              ))}
            </div>
